...
class Coupon extends \yii\db\ActiveRecord
{
     ...
     * @param integer $type 领券类型 领取类型 0--平台发放 1--自动发放 2--领券中心领取 3--积分商城
     * @return boolean
     */
    public static function userAddCoupon($user_id, $coupon_id, $coupon_auto_send_id = 0, $type = 0)
    {
        ...
        //List of coupons that can be sent automatically if they fulfill conditions of event 3 and not deleted
        //probably this should go somewhere else like in controller?? thinking...
        ...
        //if at the time this function is called, auto_send value is not 0, 
        //then it means we are sending this particular coupon automatically to some user (depends on where we will call this functions)
